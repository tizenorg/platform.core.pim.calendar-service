...
int cal_client_db_remove_changed_cb(calendar_h handle, const char* view_uri, void *callback, void* user_data);
int cal_client_db_insert_vcalendars(calendar_h hanele, const char* vcalendar_stream, int **record_id_array, int *count);
